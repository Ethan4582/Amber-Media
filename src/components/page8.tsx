...
<hr className="border-t border-white opacity-30 mb-2" />
      ...
      {/* Services Section */}
      <div className="flex-1 flex flex-col md:flex-row justify-between items-start gap-8 mb-16 relative">
        {/* Services Header */}
        <div className="w-full md:w-auto md:flex-1">
          <h2 className="text-lg font-semibold tracking-wide uppercase mb-8 md:mb-0 border-b border-white pb-2 md:border-none md:pb-0">
            SERVICES
          </h2>
        </div>

        {/* Services Lists Container */}
        <div className="flex-1 flex flex-col md:flex-row justify-end gap-16 md:gap-8 w-full">
          {/* Left Column */}
          ...
          {/* Right Column */}
          <div className="flex-1 space-y-2 md:absolute md:right-0 md:top-0">
